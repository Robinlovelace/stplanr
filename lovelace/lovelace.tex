...
A larger example of this desire line creation method is demonstrated in the code chunk below, which makes use of the function \texttt{buff\_geo}, to represent flights from New York in 2013 from the \CRANpkg{nycflights13} package.
Figure \ref{fig:flights} demonstrates how the resulting spatial object can be plotted interactively using packages such as \CRANpkg{tmap} (visualisation code not shown for brevity).
