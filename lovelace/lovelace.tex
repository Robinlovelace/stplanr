...
This may be surprising given the uqiquity of transport problems;\footnote{
...
\textbf{stplanr} imports both \CRANpkg{sp} and its successor \CRANpkg{sf}, meaning that spatial objects used in the package can be processed with base R functions such as
...
casualty system. A brief example of the latter is demonstrated below,
...
illustrate the geographic area that is covered by (or omited from) a particular service
...
This paper demonstrates that transort planning can be done with R.
