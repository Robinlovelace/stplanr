...
The \textbf{stplanr} package provides such tools, with an emphasis on spatial transport data and non-motorized modes.
...
datasets.
More broadly, the experience shows R can form the basis of an open source and reproducible
transport planning workflow.
We argue that this approach is more democratic than
the current approach which is heavily reliant on proprietary and inaccessible software.
}
